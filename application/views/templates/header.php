...
<head>
	...
	<meta name="description" content="Sistem Informasi Penggajian GADGETIN">
	<meta name="keywords" content="Sistem Informasi Penggajian GADGETIN">
	<meta name="author" content="Jihad">
	<title><?= $title ?> - GADGETIN</title>
	...
	<div class="navbar-header">
		<ul class="nav navbar-nav flex-row">
			<li class="nav-item mr-auto"><a class="navbar-brand" href="<?= base_url('dashboard') ?>">
					...
					<h3 class="brand-text">GADGETIN</h3></a></li>
