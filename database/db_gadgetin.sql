...
--
-- Database: `db_gadgetin`
--

-- --------------------------------------------------------

--
-- Table structure for table `gadgetin_absen`
--

CREATE TABLE `gadgetin_absen` (
...
--
-- Dumping data for table `gadgetin_absen`
--

INSERT INTO `gadgetin_absen` (`absen_id`, `absen_karyawan_id`, `absen_hari`, `absen_status`, `absen_date_created`) VALUES
...
--
-- Table structure for table `gadgetin_gaji`
--

CREATE TABLE `gadgetin_gaji` (
...
--
-- Dumping data for table `gadgetin_gaji`
--

INSERT INTO `gadgetin_gaji` (`gaji_id`, `gaji_karyawan_id`, `gaji_lembur`, `gaji_total`, `gaji_bayar_pinjaman`, `gaji_tanggal`, `gaji_bulan_ke`, `gaji_status`, `gaji_date_created`) VALUES
...
--
-- Table structure for table `gadgetin_jabatan`
--

CREATE TABLE `gadgetin_jabatan` (
...
--
-- Dumping data for table `gadgetin_jabatan`
--

INSERT INTO `gadgetin_jabatan` (`jabatan_id`, `jabatan_nama`, `jabatan_gaji`, `jabatan_date_created`) VALUES
...
--
-- Table structure for table `gadgetin_karyawan`
--

CREATE TABLE `gadgetin_karyawan` (
...
--
-- Dumping data for table `gadgetin_karyawan`
--

INSERT INTO `gadgetin_karyawan` (`karyawan_id`, `karyawan_jabatan_id`, `karyawan_nama`, `karyawan_tempat_lahir`, `karyawan_tanggal_lahir`, `karyawan_alamat`, `karyawan_tanggal_gabung`, `karyawan_nomor_hp`, `karyawan_no_rekening`, `karyawan_date_created`) VALUES
...
--
-- Table structure for table `gadgetin_pengguna`
--

CREATE TABLE `gadgetin_pengguna` (
...
--
-- Dumping data for table `gadgetin_pengguna`
--

INSERT INTO `gadgetin_pengguna` (`pengguna_id`, `pengguna_username`, `pengguna_password`, `pengguna_nama`, `pengguna_foto`, `pengguna_hak_akses`, `pengguna_date_created`) VALUES
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Rizki J.', NULL, 'manajer', '2019-06-28 21:06:43'),
(2, 'owner', '5be057accb25758101fa5eadbbd79503', 'Muhammad Sayfuddin', NULL, 'owner', '2019-07-15 12:27:55');

-- --------------------------------------------------------

--
-- Table structure for table `gadgetin_pinjam`
--

CREATE TABLE `gadgetin_pinjam` (
...
--
-- Dumping data for table `gadgetin_pinjam`
--

INSERT INTO `gadgetin_pinjam` (`pinjam_id`, `pinjam_karyawan_id`, `pinjam_jumlah`, `pinjam_bayar`, `pinjam_date_created`) VALUES
...
--
-- Indexes for table `gadgetin_absen`
--
ALTER TABLE `gadgetin_absen`
  ADD PRIMARY KEY (`absen_id`);

--
-- Indexes for table `gadgetin_gaji`
--
ALTER TABLE `gadgetin_gaji`
  ADD PRIMARY KEY (`gaji_id`);

--
-- Indexes for table `gadgetin_jabatan`
--
ALTER TABLE `gadgetin_jabatan`
  ADD PRIMARY KEY (`jabatan_id`);

--
-- Indexes for table `gadgetin_karyawan`
--
ALTER TABLE `gadgetin_karyawan`
  ADD PRIMARY KEY (`karyawan_id`);

--
-- Indexes for table `gadgetin_pengguna`
--
ALTER TABLE `gadgetin_pengguna`
  ADD PRIMARY KEY (`pengguna_id`);

--
-- Indexes for table `gadgetin_pinjam`
--
ALTER TABLE `gadgetin_pinjam`
...
--
-- AUTO_INCREMENT for table `gadgetin_pengguna`
--
ALTER TABLE `gadgetin_pengguna`
